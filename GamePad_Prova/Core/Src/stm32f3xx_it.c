...
void setBit(uint8_t *byte, int bit_position) {
    *byte |= (1 << bit_position);
}

// Funzione per resettare un bit specifico
...
// Funzione per controllare lo stato di un bit specifico
//uint8_t* checkBit(uint8_t *byte, int bit_position) {
